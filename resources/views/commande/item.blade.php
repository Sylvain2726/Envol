<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            <h1 class="text-3xl md:text-5xl py-4">{{ __('Détails de la commande') }}</h1>
            <div class="flex justify-end gap-4">
                <button  type="submit" form="confirmCommande" class="p-1 hidden  text-2xl text-white font-bold hover:shadow-sm hover:shadow-black focus:ring ring-emerald-500 transition-all duration-500 ring-offset-4 rounded bg-emerald-400 shadow-black shadow-inner">Confirmer</button>
                <form method="post">
                    @csrf
    ...
    <div class="relative overflow-x-auto rounded-lg shadow-sm shadow-black">
        ...
        <table class="min-w-full leading-normal text-nowrap">
            ...
            <tbody>
                ...
                <form id="confirmCommande" action="{{ route('commande.update' , $commande) }}" method="post">
                    @csrf
                    @method('PUT')
