...
<body class="bg-gardian from-gray-500 via-gray-700 to-gray-100">
            ...
            <table class="min-w-full text-center py-5 leading-normal text-nowrap">
                <thead>
                    <tr>
                        ...
                        <th
                            class="  text-lg border-2 font-bold tracking-wider text-center text-gray-900 bg-blue-400        uppercase border-b-2 border-gray-600/50">
                            Designation
                        </th>
                        <th
                            class="px-5 py-5 text-lg border-2 font-bold tracking-wider text-center text-gray-900 bg-blue-400 uppercase border-b-2 border-gray-600/50">
                            Quantité
                        </th>

                        <th
                            class="px-5  text-lg border-2 font-bold tracking-wider text-center text-gray-900 bg-blue-400 uppercase border-b-2 border-gray-600/50">
                            Prix TTC
                        </th>
                ...
                <tbody>
                    ...
                    @foreach ($items as $item)
                        ...
                        <tr class="hover:bg-slate-600">
                            ...
                            <td class="px-5  py-4 text-lg bg-white border-2 border-gray-600/50">
                                <p class="text-gray-900 whitespace-no-wrap">{{ $equipement->name }}</p>
                                </p>
                            </td>
                            <td class="px-5 py-3 text-lg bg-white border-2 border-gray-600/50">
