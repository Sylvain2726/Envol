<x-app-layout>
    ...
    <div class="flex justify-center items-center">
        ...
        <div class="bg-white w-full md:w-2/3  overflow-hidden shadow-lg shadow-black rounded-2xl">

            <div class="text-3xl text-center mt-8 ">{{ __('Ajout d\'un nouveau Equipement') }}</div>

            <div class="p-6 border-b  border-gray-200">
                <form class="space-y-6"  method="post" action="{{ route('equipement.update', ['equipement' => $equipement])}}">
                    @method('PUT')
                    @csrf
                    <div>
