    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <form class="py-4 " method="get" action="">
                <input
                    class="rounded-xl placeholder-emerald-500 ring ring-emerald-500 focus:ring focus:outline-none  p-2 border-none shadow-sm shadow-black"
                ...
                @foreach ($equipements as $equipement)
                    ...
                    <div id="dropdownDots-{{ $equipement->id }}" tabindex="-1"
                        ...
                        <ul class="py-2 text-md text-gray-700 dark:text-gray-200 "
                            ...
                            <li>
                                <form method="GET" action="{{ route('equipement.edit', ['equipement' => $equipement]) }}">
                                    @csrf
                                    <button type="submit"
